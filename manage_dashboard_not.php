...
<center>
    <div id="notifications" style="width:60%;margin-left:80px">
		<?php
			include 'conn.php';
			$q=mysql_query("SELECT *FROM mailings ORDER BY date DESC");
        ...
        <?php
			if(isset($_POST['submit']))
			{
				...
				if($q=true)
				{
					header('Location:manage_fac_not.php');
					echo "<center><span style='color:green'>Deleted Successfully</span></center>";
				}
			}
		?>
    </div>
